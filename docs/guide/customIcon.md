...
<img :src="$withBase('/custom_icon/custom_icon_3.png')" />


2. 修改"FontClass/Symbol 前缀"项为"custom-icon-"，修改"Font Family"为"custom-icon"，如下图：

<img :src="$withBase('/custom_icon/custom_icon_4.png')" />


3. 下载项目至本地

<img :src="$withBase('/custom_icon/custom_icon_1.png')" />

4. 复制"iconfont.css"至项目，一般放在根目录的`static`文件夹下

<img :src="$withBase('/custom_icon/custom_icon_2.png')" />
...
<img :src="$withBase('/custom_icon/custom_icon_8.png')" />

6. 最终如下图：

<img :src="$withBase('/custom_icon/custom_icon_9.png')" />
...
<img :src="$withBase('/custom_icon/custom_icon_7.png')" />
